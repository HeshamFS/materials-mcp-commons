...
| Invalid input or result crosses the boundary | Offline exact-profile input and result validation with structured failure documents | Numerical results also require declared sources, methods, and applicable acceptance criteria |
