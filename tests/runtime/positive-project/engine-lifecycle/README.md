...
This is project control-plane evidence, not a concrete scientific plugin. It has no external backend, network client, scientific dataset, or numerical output. W-0202 dispatches only these actual engine-owned R0 behaviors through exact binding, activation, and contract checks.
